 ...
 */
export function AdminShell({ children, role }: { children: ReactNode; role: AdminRole | null }) {
...
function AdminShellChrome({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      ...
      */}
      <div className={cn('pb-bottom-inset transition-[margin] duration-200', collapsed ? 'md:ms-20' : 'md:ms-64')}>
        {children}
      </div>
      <AdminBottomNav />
    </>
