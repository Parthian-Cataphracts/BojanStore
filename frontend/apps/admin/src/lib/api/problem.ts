...
const BY_KEY: Record<string, string> = {
  ...
  'knight-no-signing-key':
    'برای اتصال، ابتدا باید کلید امضای نایت روی سرور فروشگاه ثبت شود (Knight:SigningKeys). بدون آن، فروشگاه نمی‌تواند بسته‌هایی را که نایت تحویل می‌دهد تأیید کند و اتصال انجام نمی‌شود.',
};
